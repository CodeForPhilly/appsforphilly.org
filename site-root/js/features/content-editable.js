$(function() {
	...
	$(document).click(function(e) {
		...
		currentInitialValue = editableEl.data('content-value') || editableEl.text();
	...
	saveBtnEl.click(function(e) {
		...
		$.ajax({
			url: currentEditingEl.data('content-endpoint') + '/json/' + currentEditingEl.data('content-id') + '/edit'
			,method: 'POST'
			,data: postData
		}).done(function(responseData) {
			_renderContent(responseData.data[contentField]);
			currentEditingEl.data('content-value', responseData.data[contentField]);
